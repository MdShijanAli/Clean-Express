...
const Profile = () => {
    ...
    return (
        ...
        <div className="bg-slate-200 shadow-xl my-12 pb-6 mx-5 justify-center items-center overflow-hidden md:w-1/2 rounded-lg md:mx-auto">
            ...
            <div className="relative shadow mx-auto h-80 w-80 -mt-36 border-white rounded-full overflow-hidden border-4">
