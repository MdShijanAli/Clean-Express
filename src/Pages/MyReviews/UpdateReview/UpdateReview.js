        ...
        <form className='my-20' onSubmit={handleUpdate}>
            ...
            <div className="w-1/2 p-8 my-4 md:px-12  mx-auto   rounded-2xl shadow-2xl">
                ...
                <div className="grid grid-cols-1 gap-5 md:grid-cols-2 mt-5">
                    <input defaultValue={storedReview.name} readOnly name='name' className="w-full bg-gray-100 text-gray-900 mt-2 p-3 rounded-lg input-bordered input-primary"
                        type="text" placeholder="Name*" required />

                    <input defaultValue={storedReview?.email} readOnly name='email' className="w-full bg-gray-100 text-gray-900 mt-2 p-3 rounded-lg input-bordered input-primary"
                        type="email" placeholder="Email*" required />

                </div>
                <div className="my-4">
                    <textarea onChange={handleInputChange} defaultValue={storedReview.comment} name='comment' placeholder="Review*" className="w-full h-32 bg-gray-100 text-gray-900 mt-2 p-3 rounded-lg input-bordered input-primary" required></textarea>
                </div>
